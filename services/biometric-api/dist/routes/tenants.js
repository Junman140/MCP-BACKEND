...
export async function tenantRoutes(app) {
    app.post("/tenants", { onRequest: [app.authenticate, requireRole([Role.SUPER_ADMIN])] }, async (req, reply) => {
    ...
    app.get("/tenants", { onRequest: [app.authenticate, requireRole([Role.SUPER_ADMIN])] }, async () => {
